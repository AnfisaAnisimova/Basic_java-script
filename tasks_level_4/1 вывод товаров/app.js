...
function getProductMarkup(product) {
    product.forEach(function (el) {
        divProducts.insertAdjacentHTML('afterbegin', `<div class="product"><div>${el.name}</div><img src="${el.imageUrl}" alt=""><div>${el.price}</div><a href="https://example.com/products/${el.id}">Подробнее</a></div>`)
    })
}
